...
import static com.erhuotu.two_2.utilslibrary.Utils.IPreference.DataType.INTEGER;

/**
 * Created by TWO-2
 * 2018/9/18
 */
public class SharedPreferencesUtils implements IPreference {
    ...
    private static synchronized void initPreference(Context context, String fileName){
        if (iPreference== null){
            iPreference= new SharedPreferencesUtils(context, fileName);
        }
    }
